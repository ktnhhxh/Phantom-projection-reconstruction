file =  'D:\学习\研究生\Code\师姐重建代码\老师投影重建代码\';
...
ballbearingpos(1)= -300;        %ball bearing is located at the position (5.4mm 5.4mm 5.4mm)
ballbearingpos(2)= -300;
ballbearingpos(3)= -300;
    ...
    for index = 1:360
        ...
        for i=-15:1:15       %%%%???????y??
            ...
            for j=-15:1:15   %%%%???????x??
                ...
                Pro_Image(y+1024,x+1024) = length;
            end;
        end;
...
%          dicomwrite(I,[file,'dcmimage_1\',filename]);
%          
% %        dicomwrite();
...
%          imshow(Pro_Image,[]);
         I = int16(Pro_Image*100);
         dicomwrite(I,[file,'dcmimage_3\',filename]);
